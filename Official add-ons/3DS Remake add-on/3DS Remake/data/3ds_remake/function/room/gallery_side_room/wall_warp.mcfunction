...
execute if score #extra_gallery Selected matches 1 if entity @s[scores={PositionIntZ=-60},gamemode=spectator] run function luigis_mansion:selection_menu/extra_gallery_door/spectator_menu
