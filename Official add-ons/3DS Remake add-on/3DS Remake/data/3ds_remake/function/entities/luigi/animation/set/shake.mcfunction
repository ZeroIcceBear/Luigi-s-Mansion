...
execute unless data storage luigis_mansion:data my_memory.animation{namespace:"3ds_remake",id:"shake"} run function luigis_mansion:entities/luigi/animation/set/none
data modify storage luigis_mansion:data my_memory.animation set value {namespace:"3ds_remake",id:"shake"}
