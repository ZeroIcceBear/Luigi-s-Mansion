...
execute if data storage luigis_mansion:data saved_state[0].luigis_mansion.mansion_data[{portrait_battle:{}}] run data modify storage luigis_mansion:data saved_state[0].luigis_mansion.mansion_data append from storage 3ds_remake:data loaded_mansion.data
