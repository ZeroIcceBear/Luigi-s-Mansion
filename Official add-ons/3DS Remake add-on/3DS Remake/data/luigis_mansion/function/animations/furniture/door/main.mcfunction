...
execute if data storage luigis_mansion:data passive{tags:["blockade"]} run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "blockade"
execute if data storage luigis_mansion:data passive{tags:["barricaded"]} run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "barricaded"
execute if data storage luigis_mansion:data passive{tags:["barricaded_double"]} run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "barricaded_double"
execute if data storage luigis_mansion:data passive{tags:["burning"]} run data modify entity @s item.components."minecraft:custom_model_data".strings[0] set value "burning"
