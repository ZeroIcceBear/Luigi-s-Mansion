summon minecraft:item_display ~ ~ ~ {CustomName:{type:"translatable",translate:"luigis_mansion:furniture.candle_flame"},HasVisualFire:1b,Silent:1b,data:{entity:{namespace:"luigis_mansion",id:"furniture"},furniture_type:"candle_flame"},item_display:"head",item:{id:"minecraft:diamond_pickaxe",count:1,components:{"minecraft:item_model":"luigis_mansion:furniture/candle_flame","minecraft:custom_model_data":{floats:[0f]}}},Tags:["furniture","candle_flame","immobile","can_be_fire_elemental_source","searchable_by_vacuum","searchable_by_dust","searchable_by_fire","searchable_by_water","searchable_by_ice","freeze_animation_next_tick","same_room_players_only","this_entity"],brightness:{block:15,sky:15}}
teleport @e[tag=this_entity,tag=candle_flame,limit=1] ~ ~ ~ ~ ~
...
execute if data storage luigis_mansion:data candle_flame{type:"incense"} run data modify entity @e[tag=this_entity,tag=candle_flame,limit=1] Tags set value ["furniture","candle_flame","incense","can_be_fire_elemental_source","static","affected_by_vacuum","searchable_by_vacuum","spawn_particles","freeze_animation_next_tick","same_room_players_only","this_entity"]
...
scoreboard players set @e[tag=this_entity,tag=candle_flame,limit=1] FurniturePoseX 0
scoreboard players set @e[tag=this_entity,tag=candle_flame,limit=1] FurniturePoseY 0
scoreboard players operation @e[tag=this_entity,tag=candle_flame,limit=1] FurniturePoseZ = @e[tag=this_entity,tag=!candle_flame,limit=1] FurniturePoseZ
