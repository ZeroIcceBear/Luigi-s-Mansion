...
data modify entity @s[scores={ActionTime=21}] item merge from entity @s item.components."minecraft:custom_data".model_data.falling
...
execute if entity @s[scores={ActionTime=134}] run tag @e[distance=..0.1,tag=falling_chandelier_rod] add dead
data modify entity @s[scores={ActionTime=134}] item merge from entity @s item.components."minecraft:custom_data".model_data.default
