execute if entity @s[tag=!portrait,tag=!portrificationizing,tag=!done_portrificationizing,tag=!no_ai] run function luigis_mansion:entities/mario/ai with entity @s data.mansion
...
execute if entity @s[tag=portrait,tag=!remove_from_existence] run function luigis_mansion:entities/mario/portrait with storage luigis_mansion:data macro
