...
execute if score #dialog Dialog matches 500 positioned 751.0 11 9.0 rotated -90 90 run function luigis_mansion:spawn_entities/item/key {door:"parlor"}
